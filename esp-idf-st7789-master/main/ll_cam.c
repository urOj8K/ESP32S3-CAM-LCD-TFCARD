...
//         conf.pin_bit_mask = 1LL << config->pin_pclk;
//         conf.mode = GPIO_MODE_INPUT;
//         gpio_config(&conf);

//         conf.pin_bit_mask = 1LL << config->pin_vsync;
//         gpio_config(&conf);

//         conf.pin_bit_mask = 1LL << config->pin_href;
//         gpio_config(&conf);

//         conf.pin_bit_mask = 1LL << config->pin_d0;
//         gpio_config(&conf);

//         conf.pin_bit_mask = 1LL << config->pin_d1;
//         gpio_config(&conf);

//         conf.pin_bit_mask = 1LL << config->pin_d2;
//         gpio_config(&conf);

//         conf.pin_bit_mask = 1LL << config->pin_d3;
//         gpio_config(&conf);

//         conf.pin_bit_mask = 1LL << config->pin_d4;
//         gpio_config(&conf);

//         conf.pin_bit_mask = 1LL << config->pin_d5;
//         gpio_config(&conf);

//         conf.pin_bit_mask = 1LL << config->pin_d6;
//         gpio_config(&conf);

//         conf.pin_bit_mask = 1LL << config->pin_d7;
//         gpio_config(&conf);

//         conf.pin_bit_mask = 1LL << config->pin_xclk;
